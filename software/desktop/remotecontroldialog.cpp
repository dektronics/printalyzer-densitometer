    ...
    sensorConfigOnStart_(true)
{
    ...
    connect(densInterface_, &DensInterface::diagSensorReading, this, &RemoteControlDialog::onDiagSensorReading);
...
void RemoteControlDialog::onDiagSensorReading(int ch0, int ch1)
{
